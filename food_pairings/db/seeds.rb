...
Drink.create name: "Moscato", description: "preferably the nicki minaj brand"
Drink.create name: "Jager Bombs", description: "insert attack on titan joke lolol"
Drink.create name: "Natty Light", description: "moldy water"